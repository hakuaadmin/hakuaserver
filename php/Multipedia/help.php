...
<!--これはテンプレートです！決して直接編集しないでください-->
<html>
  <head>
    <meta charset="utf-8">
    <title>GHSマルチペディア</title>
    <link rel="stylesheet" href="../../css/Multipedia/help.css">
    <link rel="stylesheet" href="../../css/Multipedia/template.css">
  </head>

  <body>
    <header>
      <div class="top_left">
        <a id="page" href="help.php">ページ</a>
        <a id="note" href="note/note_help.php">ノート</a>
        <a id="source" href="sr/source_help.php">ソース表示</a>
        <a id="history" href="history/history_help.php">履歴表示</a>
      </div>
    </header>
    <article>
      <!--レフトサイドメニューの項目-->
      <div class="side">
        <a href="../Main/index.php"><img id="logo" src="../../img/server-icon.png" width="100" height="100"></a>
        <ul>
