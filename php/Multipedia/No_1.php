...
<html>
  ...
  <body>
    <header>
      <div class="top_left">
        <a id="page" href="メインのphpはここ">ページ</a>
        <a id="note" href="ノートのphpはここ">ノート</a>
        <a id="source" href="出典のphpはここ">ソース表示</a>
        <a id="history" href="履歴のphpはここ">履歴表示</a>
      </div>
    </header>
    <article>
      <!--レフトサイドメニューの項目-->
      ...
      <div class="content">
        <div class="info">
          <h2 style="color:#ff0000">重要なお知らせ</h2>
          <h4>検索フォームについて</h4>
          <a>検索フォームについて</a>
        </div>
      </div>
